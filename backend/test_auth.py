...
success &= test_login('9876543210', 'Admin123', 'admin', 200)

# 2. Admin logs in as customer
success &= test_login('9876543210', 'Admin123', 'customer', 403)
...
success &= test_login('9876543299', 'password123', 'customer', 200)

# 5. Customer logs in as admin
success &= test_login('9876543299', 'password123', 'admin', 403)
