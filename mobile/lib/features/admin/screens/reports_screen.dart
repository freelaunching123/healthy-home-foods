  ...
  Widget _buildBusinessSummary() {
    ...
    return GridView.count(
      ...
      children: [
        ...
        _buildSummaryCard(Icons.apple_rounded, const Color(0xFFF59E0B), const Color(0xFFFFF8E1), 'Fruit Orders', fruitOrd.toString()),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildLegendItem(const Color(0xFFF59E0B), 'Fruit Orders', fruitOrd.toInt()),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildHighlightRow(Icons.star_rounded, 'Best Selling Fruit', bestFruit),
