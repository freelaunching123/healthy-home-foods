              ...
              background: Stack(
                ...
                children: [
                  _product!['image_url'] != null
                      ? CachedNetworkImage(
                          imageUrl: '${_api.mediaBaseUrl}${_product!['image_url']}',
                          fit: BoxFit.cover,
                          placeholder: (context, url) => Container(color: Colors.grey.shade200),
                          errorWidget: (context, url, error) => Container(color: Colors.grey.shade200, child: const Center(child: Icon(Icons.eco, size: 64, color: AppTheme.primaryGreen))),
                        )
                      : Container(color: Colors.grey.shade200, child: const Center(child: Icon(Icons.eco, size: 64, color: AppTheme.primaryGreen))),
