        ...
        children: [
          ...
          _InsightCard(
            ...
            subtitle: topFruit != null
                ...
                : null,
            emptyText: 'No grocery orders yet',
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        const reservedHeight = 44.0;
        final maxBarHeight = math.max(availableHeight - reservedHeight, 20.0);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AnimatedContainer(
                      ...
                      height: math.max(ratio * maxBarHeight, rev > 0 ? 4.0 : 2.0),
                      decoration: BoxDecoration(
