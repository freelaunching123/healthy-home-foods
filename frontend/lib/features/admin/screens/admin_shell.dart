            ...
            if (MediaQuery.of(context).size.width > 600)
              NavigationRail(
                ...
                destinations: const [
                  ...
                  NavigationRailDestination(icon: Icon(Icons.shopping_bag_outlined), selectedIcon: Icon(Icons.shopping_bag), label: Text('Groceries')),
        ...
        bottomNavigationBar: MediaQuery.of(context).size.width <= 600
            ? NavigationBar(
                ...
                destinations: const [
                  ...
                  NavigationDestination(icon: Icon(Icons.shopping_bag_outlined), selectedIcon: Icon(Icons.shopping_bag, color: AppTheme.primaryGreen), label: 'Groceries'),
